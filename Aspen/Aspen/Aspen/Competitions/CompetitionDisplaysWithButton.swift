//
//  CompetitionDisplaysWithButton.swift
//  Aspen
//
...
struct CompetitionDisplaysWithButton: View, Hashable, Identifiable {
    var id = UUID()
    ...
    var body: some View {
        ZStack{
            ...
            VStack(alignment: .leading) {
                ...
                }.buttonStyle(GradientFullButtonStyle())                    .padding(.top, 15)
...
struct CompetitionDisplaysWithButton_Previews: PreviewProvider {
    static var previews: some View {
        CompetitionDisplaysWithButton()
    }
}
